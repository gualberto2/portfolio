...
const HomeCardsLarge = () => {
  return (
    <section className="mt-16">
      <div>
        <div className="grid grid-cols-2 grid-rows-3 md:grid-cols-6 md:grid-rows-3 ">
          ...
          <div className="bg-gradient-to-r from-[#A7C7C4] to-[#9FC6C2] hover:from-[#B4CFCD] hover:to-[#B4CFCD] p-12 rounded-3xl m-2 transition duration-150 ease-in-out transform cursor-pointer  card col-start-1 col-end-3 row-start-2 row-end-3 md:col-start-2 md:col-end-4 md:row-start-2 md:row-end-3 z-20">
