...
const Home = () => {
  ...
  return (
    <body className="px-2">
      <section className="max-w-[95%] mx-auto xl:max-w-6xl">
        ...
        <section className="mt-16">
          <div>
            <div className="grid grid-cols-2 grid-rows-3 md:grid-cols-5 md:grid-rows-3 ">
              {/* Main card //// */}
              <div className="bg-gradient-to-r from-[#88A0BF] to-[#7D9ABF] hover:from-[#7A95B8] hover:to-[#7A95B8] transition duration-150 ease-in-out transform p-12 md:p-0 md:text-center md:py-12 rounded-3xl m-2 col-start-1 col-end-3 row-start-1 row-end-2 md:col-start-3 md:col-end-4  md:row-start-1 md:row-end-2 cursor-pointer card">
                <h2 className="text-xl text-inherit font-normal uppercase">
                  Card
                </h2>
                <h1 className="text-4xl text-inherit font-medium uppercase">
                ...
                <RxDoubleArrowRight className="absolute hidden md:inline-block bottom-8 right-10 text-2xl icon-animation transition duration-200 ease-in-out" />
              </div>
              {/* Sub card 2 */}
              <div className="bg-gradient-to-r from-[#A7C7C4] to-[#9FC6C2] hover:from-[#B4CFCD] hover:to-[#B4CFCD] p-12 rounded-3xl m-2 transition duration-150 ease-in-out transform cursor-pointer  card col-start-1 col-end-3 row-start-2 row-end-3 md:col-start-3 md:col-end-4 md:row-start-2 md:row-end-3">
